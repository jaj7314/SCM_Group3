        ...
        <div class="screen">
            ...
            <div class="order-container">
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ?>
                                        <tr>
                                            ...
                                            <td style="text-align:right;"><?php echo "RM" . $row["price"]; ?></td>
                                            <td style="text-align:center;">
                                                <a href="viewdetails.php?orderid=<?php echo $row["id"]; ?>" style=" color: lightblue;">View Details</a>
                                            </td>
                                        </tr>
                                        <?php
                                }
                ...
                <?php 
                    ...
                    <div style="padding-top: 20px; padding-left: 30px; font-size: 20px; color:lightgreen">There is no order in your account!</div>
