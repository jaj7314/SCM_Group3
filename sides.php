...
<body>
		...
		<div>
		    <img src="img/SidesHeader.png" style="width:100%">
		</div>
        <div id="product-grid">
            <?php
            $product_array = $db_handle->runQuery("SELECT * FROM products WHERE category = 'sides' ORDER BY id ASC ");
            ...
            ?>
                    <form class="menupanel" method="post" action="addtocart.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
                        ...
                        <div style="display: none;">
                                ...
                                <input type="text" name="page" value="sides.php" />
