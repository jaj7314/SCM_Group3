                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center;"><?php echo $row["fk_user_id"]; ?></td>
                                ...
                                ?>
                                <tr>
                                    <td style="background-color: black; font-size: 20px; border-right: 0;" colspan="6" align=right><strong>Total:</strong></td>
