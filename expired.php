...
<body >
		...
		<!-- Continue here -->
        <div class="message">
			<h2 style="font-size: 23px;"><strong>Error!</strong></h2><br/>
			<p style="font-size: 18px;">This verification link is already expired or doesn't exist, please contact our customer service for further assistant.
				<br/>
				<br/>
