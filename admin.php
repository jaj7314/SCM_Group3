        ...
        <div class="screen">
            ...
            <div class="order-container">
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ?>
                                        <tr>
                                            ...
                                            <td stlye="text-align: right;"><?php echo $row["username"] ?></td>
                                            <td style="text-align: right;"><?php echo $row["email"] ?></td>
                                            <td style="text-align:center;"><?php if($row["status"] == 'Active') {
                                            echo "Verified";} else {
                                                echo "Not Verify Yet";
                                            } ?></td>
                                            <td style="text-align:center;">
                                                <a href="admin-viewuserdetails.php?userid=<?php echo $row["id"]; ?>" style=" color: lightblue;">View User Orders</a>
                                            </td>
                                        </tr>
                                        <?php
                                }
                ...
                <?php 
                    ...
                    <div style="padding-top: 20px; padding-left: 30px; font-size: 20px; color:lightgreen">Unfortunately, no order is made by users.</div>
